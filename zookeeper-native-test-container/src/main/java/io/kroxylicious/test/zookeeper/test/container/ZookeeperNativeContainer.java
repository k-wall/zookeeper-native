...
public class ZookeeperNativeContainer extends GenericContainer<ZookeeperNativeContainer> {
    ...
    public static final String DEFAULT_REPOSITORY = System.getProperty("zookeeper-native-container-image", "quay.io/k_wall/zookeeper-native");
    ...
    public ZookeeperNativeContainer withPort(int fixedPort) {
        ...
        addFixedExposedPort(fixedPort, ZOOKEEPER_PORT);
        return self();
    }
