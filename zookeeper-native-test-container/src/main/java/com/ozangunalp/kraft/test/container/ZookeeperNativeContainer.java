...
public class ZookeeperNativeContainer extends GenericContainer<ZookeeperNativeContainer> {
    ...
    public static final String DEFAULT_REPOSITORY = System.getProperty("kafka-native-container-image", "quay.io/k_wall/zookeeper-native");
    ...
    private Function<ZookeeperNativeContainer, String> advertisedListenersProvider = ZookeeperNativeContainer::defaultAdvertisedAddresses;
    ...
    public ZookeeperNativeContainer withPort(int fixedPort) {
        assertNotRunning();
        if (fixedPort <= 0) {
    ...
    public ZookeeperNativeContainer withServerProperties(MountableFile serverPropertiesFile) {
        assertNotRunning();
    ...
    public ZookeeperNativeContainer withAdvertisedListeners(final Function<ZookeeperNativeContainer, String> provider) {
        assertNotRunning();
        this.advertisedListenersProvider = provider;
        return self();
    }

    public ZookeeperNativeContainer withArgs(String args) {
        assertNotRunning();
    ...
    public static String defaultAdvertisedAddresses(ZookeeperNativeContainer container) {
